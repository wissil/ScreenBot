...
public class BetReportGenerator {
	...
	private static StringBuilder generateSingleParameter(StringBuilder sb, String paramKey, String paramValue, int len) {
		...
		for (int i=sb.length(); i<len-1; i++) sb.append(" ");
		sb.append("|");
		sb.append(System.lineSeparator());
