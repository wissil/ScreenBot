...
public class PlaceBetState extends VBState {
    ...
    void execute() throws InterruptedException, FatalVBException {
        ...
        try {
            ...
            final boolean shouldPlaceBet = BetEvaluator.shouldPlaceBet(oddsLimit, oddsActual, stake, balance, max, min);
            ...
            final BetReport report = new BetReport(bookie.toString(), value, oddsLimit, oddsActual, stake, balance, max, min, shouldPlaceBet);
