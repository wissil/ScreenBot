...
public class PlaceBetState extends VBState {
    ...
    void execute() throws InterruptedException, FatalVBException {
        ...
        try {
            ...
            final BetReport report = new BetReport(bookie.toString(), value, oddsLimit, oddsActual, stake, balance, 0, 0, shouldPlaceBet);
